...
Now that the gesture analyser is working and tested with TUIO events, the next step is to use VM events. Ir order to be able to switch, the Vm have to be modified.
